...
def serialize():
    ...
    with open("./sample/players.bin", "wb") as f:
        ...
        pickle.dump({"basketball", 5}, f, pickle.HIGHEST_PROTOCOL)  # 최긴 피클 버전
...
- ,를 기준으로 분할
- 한 개 레코드를 dict
    - {"name":채지수, "backno":4, "height":197, "position":센터}
